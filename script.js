...
var contenedorSinResultado = document.querySelector("#contenedorSinResultado");
var contenedorConResultado = document.querySelector("#contenedorConResultado");
...
function reemplazarLetrasReverso(textoPorDesencriptar) {
  for (var i = 0; i < letrasPorEncriptar.length; i++) {
    ...
    if (textoDesencriptado) {
      ...
      textoDesencriptado = textoPorDesencriptar.replaceAll(encriptacion, letra);
    }
  }
}
...
function descifrar() {
  ...
  console.log(textoPorDesencriptar);
